...
#             .prefetch_related("zone_images")  # for main_image_url in serializer
#         )
...
#         # ----------------------------
#         month = p.get("month")
#         # We only apply condition filters if month is present OR if a condition filter is provided.
#         # If you want to enforce month always, you can require it on the frontend.
...
#             # If month is provided, constrain the join to that month
#             if month:
...
#             # JOINs on conditions can duplicate zones
#             qs = qs.distinct()
...
#     def get_queryset(self):
#         # Detail: include country, images, conditions, and surf_spots + their images for main_image_url
#         return (
#             SurfZone.objects
#             .select_related("country")
#             .prefetch_related(
...
#     """
#     Docstring for SurfSpotLiteListAPIView
#     List SurfSpots with lightweight payload + backend filtering.
#     Filters supported (query params):
#     - surfzone_id (UUID) OR surfzone_slug
#     - best_month (e.g. "July")  -> filters spots with this month in best_months ArrayField
#     - surf_level (e.g. "Beginner")  -> ArrayField contains
#     - best_tide (e.g. "High")  -> ArrayField contains
#     - break_type (e.g. "Beach")  -> exact match
#     - wave_direction (e.g. "Left")  -> exact match
#     - best_wind_direction (e.g. "Offshore")  -> exact match
#     - best_swell_direction (e.g. "NW")  -> exact match
...
#             .prefetch_related("spot_images")  # for 1 thumbnail
#         )
...
#     """
#     Docstring for SurfSpotDetailAPIView
...
#             .prefetch_related("spot_images")
#             .all()
#         )

# ============================
# V3 endpoints (optimized)
# ============================
